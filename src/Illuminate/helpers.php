...
if (! function_exists('url')) {
	 ...
	 */
	function url(?string $path = null, mixed $parameters = [], ?bool $secure = null): string|UrlGenerator
    {
...
if (! function_exists('validator')) {
	 ...
	 */
	function validator(?array $data = null, array $rules = [], array $messages = [], array $attributes = []): Validator|ValidationFactory
    {
...
if (! function_exists('view')) {
     ...
     * @return View|Application|ViewFactory
     */
	function view(?string $view = null, Arrayable|array $data = [], array $mergeData = []): View|Application|ViewFactory
    {
